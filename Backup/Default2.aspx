...
<body style="text-align:auto;margin:auto;">
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="View1" runat="server">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlGetAllEvents" 
                        ...
                        GridLines="None" AutoGenerateColumns="False" DataKeyNames="eventid">
                ...
                <asp:View ID="View2" runat="server">
                  <div style="width:310px;text-align:auto;margin:auto;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox id="txtStudentID" ontextchanged="txtStudentID_TextChanged" style="width: 280px; height: 220px;" runat="server" onblur="txtAge_onblur()" BackColor="#D9EBF9"></asp:TextBox>                                      
                            </td>
                        </tr>               
                        <tr>
                            <td>
                    ...
                    <asp:SqlDataSource ID="SqlDailyAttendCount" runat="server"  ConnectionString="<%$ ConnectionStrings:ApplicationConnectionString %>" SelectCommand="select count(distinct scannedid) as Event_Attendance  from attendance where eventID = @eventID">
                        <SelectParameters>  
                            <asp:QueryStringParameter Name="eventID" QueryStringField="id" />  
                        </SelectParameters> 
					</asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlSelectedEvent" runat="server"  ConnectionString="<%$ ConnectionStrings:ApplicationConnectionString %>" SelectCommand="
                        select	eventid
                                , eventTitle
    ...
    <asp:SqlDataSource ID="SqlGetAllEvents" runat="server"  ConnectionString="<%$ ConnectionStrings:ApplicationConnectionString %>" SelectCommand="select	eventid
                        , eventTitle
		                , coalesce(eventDesc,'') as eventDesc, coalesce(eventPresenter,'') as eventPresenter, coalesce(eventLoc,'') as eventLoc
		                , case when convert(varchar(9),startdatetime,110) = convert(varchar(9),enddatetime,110) then 
			                convert(varchar(20),startdatetime,100) + '-' + right(convert(varchar(20),enddatetime,100),7)
                ...
                where	e.status = 'a'
		                and e.cancelled = 'n'
                        and e.endDateTime > dateAdd(d,-5,getdate())
